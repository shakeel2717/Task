                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center bg-white">
                        ...
                        <div class="btn-group" role="group">
                            <a href="{{ route('tasks.index') }}" class="btn btn-sm btn-outline-primary">All</a>
                            <a href="{{ route('tasks.active') }}" class="btn btn-sm btn-outline-success">Active</a>
                            <a href="{{ route('tasks.completed') }}"
                                class="btn btn-sm btn-outline-secondary">Completed</a>
                        </div>
                    </div>
                            ...
                            <div class="card task-card mb-3">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="ms-2 text-muted">Created:
